...
Elm.Modal.make = function (_elm) {
   ...
   var _op = {};
   var view = F2(function (address,model) {    return A2($Html.div,_U.list([$Html$Attributes.$class("modal fade")]),_U.list([$Html.text("What it do")]));});
   var update = F2(function (action,model) {    var _p0 = action;return {ctor: "_Tuple2",_0: model,_1: $Effects.none};});
   var NoOp = {ctor: "NoOp"};
   var initialModel = {$class: "test"};
   var app = $StartApp.start({init: {ctor: "_Tuple2",_0: initialModel,_1: $Effects.none},update: update,view: view,inputs: _U.list([])});
   var main = app.html;
   var Model = function (a) {    return {$class: a};};
   return _elm.Modal.values = {_op: _op,Model: Model,initialModel: initialModel,NoOp: NoOp,update: update,view: view,app: app,main: main};
};
