...
Elm.Modal.make = function (_elm) {
   ...
   var update = F2(function (action,model) {
      var _p0 = action;
      if (_p0.ctor === "ToggleModal") {
            return {ctor: "_Tuple2",_0: _U.update(model,{isShown: $Basics.not(model.isShown)}),_1: $Effects.none};
         } else {
            return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
         }
   });
   var ToggleModal = {ctor: "ToggleModal"};
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.id("container")]),
      _U.list([A2($Html.button,_U.list([$Html$Attributes.type$("button"),A2($Html$Events.onClick,address,ToggleModal)]),_U.list([$Html.text("Show Modal")]))
              ,A2($Html.div,
              ...
              _U.list([A2($Html.div,
                      ...
                      _U.list([$Html.text("This is a modal header")
                              ...
                              _U.list([$Html$Attributes.$class("close")
                                      ...
                                      ,A2($Html$Events.onClick,address,ToggleModal)]),
   ...
   var NoOp = {ctor: "NoOp"};
   var input = function () {
      var toAction = function (escapeKey) {    return _U.eq(escapeKey,27) ? ToggleModal : NoOp;};
      var escapeKey = $Keyboard.keysDown;
      return toAction;
   }();
   var escKeyPressed = function (keyCode) {    var _p1 = keyCode;if (_p1 === 27) {    return ToggleModal;} else {    return NoOp;}};
   var initialModel = {isShown: false,options: {keyboard: true,show: false,backdrop: false}};
   var app = $StartApp.start({init: {ctor: "_Tuple2",_0: initialModel,_1: $Effects.none}
                             ,update: update
                             ,view: view
                             ,inputs: _U.list([A2($Signal.map,escKeyPressed,modalPort)])});
   var tasks = Elm.Native.Task.make(_elm).performSignal("tasks",app.tasks);
   var main = app.html;
   var Config = F3(function (a,b,c) {    return {keyboard: a,show: b,backdrop: c};});
   var Model = F2(function (a,b) {    return {isShown: a,options: b};});
